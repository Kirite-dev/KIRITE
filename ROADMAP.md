...
- [x] Confidential Transfer (Twisted ElGamal, SPL Token-2022 integration)
- [x] Shield Pool (Pedersen commitments + Merkle tree + nullifier)
- [x] Stealth Address (DKSAP, ECDH dual-key)
